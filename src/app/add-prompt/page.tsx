  ...
  return (
    <div className="flex flex-col items-center p-8">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-2xl flex flex-col gap-6">
        {error && (
          <div className="bg-red-50 text-red-600 p-4 rounded-md flex items-center gap-2 text-sm" role="alert">
        ...
        <div className="grid gap-2">
          ...
          <Input
            id="title"
            placeholder="e.g. Django API Boilerplate"
            value={title}
        ...
        <div className="grid gap-2">
          ...
          <Input
            id="tags"
            placeholder="e.g. python, backend, api (comma-separated)"
            value={tags}
