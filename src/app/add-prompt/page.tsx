...
const AddPromptPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // but mostly to ensure the spinner doesn't flash too briefly on fast networks
      // before redirect.
    ...
    <div className="flex flex-col items-center p-8">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-2xl flex flex-col gap-6">
        ...
        <div className="grid gap-2">
          ...
          <Textarea
            id="promptText"
            placeholder="The actual prompt text goes here..."
            value={promptText}
        ...
        <div className="grid gap-2">
          ...
          />
          <p id="tags-helper" className="text-[0.8rem] text-muted-foreground">
